...
while True:
    ...
    timestamped_imu_readings[4:7] = np.array(lsm6ds33.get_accelerometer_angles())
    timestamped_imu_readings[7:10] = np.array(lsm6ds33.get_gyro_angular_velocity())
    timestamped_imu_readings[10:] = np.array(lis3mdl.get_magnetometer_raw())/MAGNETOMETER_LSB
